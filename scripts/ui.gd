...
func _process(delta: float) -> void:
	if Input.is_action_just_pressed("escape_interact") && already_interacted_with_menu == false:
	...
	elif Input.is_action_just_pressed("escape_interact") && already_interacted_with_menu == true:
